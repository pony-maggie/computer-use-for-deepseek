...
const translations = {
  "en-US": {
    ...
    "sandbox.viewportIdle": "Runtime viewport pending",
    "sandbox.viewportApplying": "Applying to sandbox",
    "sandbox.viewportApplied": "Applied to sandbox",
    "sandbox.viewportFailed": "Preview only; runtime update failed",
  ...
  "zh-CN": {
    ...
    "sandbox.viewportIdle": "运行视口待同步",
    "sandbox.viewportApplying": "正在应用到沙箱",
    "sandbox.viewportApplied": "已应用到沙箱",
    "sandbox.viewportFailed": "仅预览，运行时同步失败",
